<div class="officeTypes index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Ver'), array('action' => 'view', $officeType['OfficeType']['id'])); ?>
			<?php echo $this->Html->link(__('Modificar'), array('action' => 'edit', $officeType['OfficeType']['id'])); ?>
			<?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $officeType['OfficeType']['id']), null, __('Are you sure you want to delete # %s?', $officeType['OfficeType']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
